# Operator Quickstart — Activities of business and employers membership organizations

Shortest path from clone to a verified local dry-run for **ISIC 9411** (`cloud-itonami-isic-9411`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-9411.git
cd cloud-itonami-isic-9411
```
...
- Blueprint governor key: `association-governance-governor`
- Likely source path: `bizassoc.governor.cljc`
